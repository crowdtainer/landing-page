...
<div class="lg:mx-28 md:mx-12 sm:mx-10 mt-10 space-y-10 max-w-3xl">
	...
	<div class="flex justify-center my-5 pb-20 space-x-4 w-full">
		<img alt="Project screenshot" src="/images/ResponsiveUI.png" />
	</div>

	<div class="flex justify-center">
		<p class="text-xl mx-10">Users can leave before before funding time completes:</p>
	</div>
	<div class="flex justify-center my-5 pb-20 space-x-4 w-full">
		<img alt="Project screenshot" src="/images/screen_Leave.png" />
	</div>
	...
	<div class="flex justify-center">
		<p class="text-xl mx-10">Check-out page:</p>
	</div>
	<div class="flex justify-center my-5 pb-20 space-x-4">
